...
const sendTransaction = async (provider: IProvider): Promise<string> => {
  try {
    const solanaWallet = new SolanaWallet(provider);
...
const signTransaction = async (provider: IProvider): Promise<string> => {
  try {
    const solanaWallet = new SolanaWallet(provider);
    const connectionConfig = await solanaWallet.request<
      string[],
...
const sendVersionTransaction = async (provider: IProvider): Promise<string> => {
  try {
    const solanaWallet = new SolanaWallet(provider);
    const connectionConfig = await solanaWallet.request<
      string[],
...
// const mintNFT = async (provider: IProvider): Promise<string> => {
//   const solanaWallet = new SolanaWallet(provider);
...
const getPrivateKey = async (provider: IProvider): Promise<string> => {
  const privateKey = await provider.request({
    method: "solanaPrivateKey",
  });
